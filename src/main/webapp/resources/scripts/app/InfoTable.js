var InfoTable = React.createClass({
	...
	componentDidMount: function () {
		if (this.isMounted()) {
			this.loadLabels();
			if (typeof this.props.incomeData2.data !== "undefined" || typeof this.props.incomeData3.data !== "undefined" || typeof this.props.incomeData10.data !== "undefined" || typeof this.props.loanData.data !== "undefined") {
	...
	componentWillReceiveProps: function (newProps) {
		if (typeof newProps.incomeData2.data !== "undefined" && typeof newProps.loanData.data !== "undefined") {
			if (JSON.stringify(this.state.incomeData2) !== JSON.stringify(newProps.incomeData2) && JSON.stringify(this.state.incomeData3) !== JSON.stringify(newProps.incomeData3) && JSON.stringify(this.state.incomeData10) !== JSON.stringify(newProps.incomeData10) && JSON.stringify(this.state.loanData) !== JSON.stringify(newProps.loanData)) {
	...
	loadLabels: function () {
		var labels = [{ "name": "Sex", "value": "Sex", "options": { "1": "Female", "2": "Male", "*": "Total" } }, { "name": "Degree", "value": "Degree", "options": { "1": "None", "2": "Associate", "3": "Bachelor", "4": "Graduate", "5": "Other", "*": "Total" } }, { "name": "School", "value": "School", "options": { "1": "Gryffindor", "2": "Ravenclaw", "3": "Hufflepuff", "4": "Slytherin", "*": "Total" } }];
	...
	render: function () {
		...
		if (data.length > 0) {
			table = React.createElement(
				...
				React.createElement(
					"table",
					{ className: "table table-hover", id: "infoTable", style: { width: "100%" } },
					React.createElement(
						"thead",
						null,
						React.createElement(
							...
							React.createElement(
								"th",
								{ scope: "col" },
								"Average Income 3 years after graduation"
							),
							React.createElement(
								"th",
								{ scope: "col" },
