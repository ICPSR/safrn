var InfoTable = React.createClass({
	...
	createTable: function () {
		var infoTable = $('#infoTable').DataTable({
			...
			columns: [{ title: "Institution" }, { title: "Degree" }, { title: "Average Loan" }, { title: "Average Income 2 years after graduation" }, { title: "Average Income 3 years after graduation" }, { title: "Average Income 10 years after graduation" }],
